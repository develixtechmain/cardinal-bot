...
const afterTexts: PartialText[] = [
    {
        ...
        textParts: [
            {
                text: "Активируется пробный доступ на 3 дня —"
            },
            {
                text: "ты сразу начнёшь получать заявки",
                bold: true
            }]
    },
    {
        ...
        textParts: [
            {
                text: "ИИ создаст персональное облако тегов —"
            },
            {
                text: "по нему будет идти подбор самых релевантных заявок",
                bold: true
            }]
    },
    {
        ...
        textParts: [
            {
                text: "Откроется доступ ко всем"
            },
            {
                text: "ключевым функциям системы", bold: true
            }]
    }
]
...
export default function BriefingIntro() {
    ...
    return (
        <div className={styles.container}>
            <Header/>
            <div className={styles.introBackground}><img src="/assets/finder/briefing/intro-background.svg" alt=" "/></div>
            ...
            <div className={styles.introTitle}>
                ...
                <div className={styles.row}>
                    <img height="19px" width="19px" className={styles.smallStep} src="/assets/finder/briefing/eagle.svg"
                         alt=" "/>
                    <span>Cardinal</span>
                    <div className={styles.midStep}><span className={styles.colored}>*</span></div>
                    <span>начнёт</span>
                    <img height="19px" width="24px" className={styles.largeStep} src="/assets/finder/briefing/spy.svg"
                         alt=" "/><span>искать</span>
                </div>
                <div className={styles.row}>
                        ...
                        <div>
                            {textParts.map(({bold, text}, index) => (
                                <span key={index} className={styles.afterText}>
                                    <span style={bold ? {fontWeight: 700} : {}}>{text}</span>
            ...
            <div className={styles.remark}>
                ...
                <span
                    className={styles.remarkText}>Cardinal — это умный софт на базе ИИ, который сам подбирает самые релевантные заявки под твой профиль.</span>
            </div>

            <div style={{flex: 1}}/>
            <button className={styles.startButton} disabled={isDisabled}
                    onClick={() => navigate("/finder/briefing/alert")}>
                Пройти брифинг
            </button>
