...
const Subscription: FC = () => {
    ...
    const subscriptionButton = (
        <WideButton
            ...
            textColor={months === 12 ? "black" : "white"}
            text={
    ...
    return (
        <div className={styles.container}>
            ...
            <div className={styles.monthsSelector} style={{"--border-from": borderFromColor, "--border-to": borderToColor} as React.CSSProperties}>
                <div
                    className={`${styles.monthBlock} ${months === 1 ? styles.monthSelected : ""}`}
                    style={{"--month-from": "#7211F8", "--month-to": "#430A92"} as React.CSSProperties}
                    onClick={() => setMonths(1)}
                >
                    <span>
                ...
                >
                    ...
                    <div className={styles.monthDiscount} style={{"--color": "white", "--background-color": "#7211F8"} as React.CSSProperties}>
                        -15%
                    </div>
                </div>
                <div
                    className={`${styles.monthBlock} ${months === 12 ? styles.monthSelected : ""}`}
                    style={{"--month-from": "#BEF811", "--month-to": "#6B8F00"} as React.CSSProperties}
                ...
                >
                    ...
                    <div className={styles.monthDiscount} style={{"--color": "black", "--background-color": "#BEF811"} as React.CSSProperties}>
                        -30%
                    </div>
                </div>
            </div>
            ...
            <div className={styles.featuresContainer}>
                <div className={styles.featuresTitle} style={{"--background-color": featuresTitleColor} as React.CSSProperties}>
                    ПОДПИСКА
                </div>
                {months === 3 ? (
