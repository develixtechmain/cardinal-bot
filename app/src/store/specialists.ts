const specialists = new Map([
    ...
    [
        ...
        {
            services: ["Генерация изображений ИИ", "ИИ генеративное видео", "Синтез голосов и аудио дорожек через AI", "Разработка AI-контента под запрос"],
            additionalServices: ["Улучшение AI-контента", "Консультации по GenAI", "Обучение GenAI"],
            projectTypes: [
    ...
    [
        ...
        {
            services: ["Разработка веб-сайтов «под ключ»", "Создание веб-приложений", "Проектирование БД и API", "Интеграция фронта и бэка"],
            additionalServices: [
    ...
    [
        "Сторисмейкер",
        {
            services: ["Оформление Stories", "Сторителлинг под запуск", "Интерактивные сторис ", "Оформление Stories"],
            additionalServices: ["Аналитика Stories", "Повышение вовлечённости Stories", "Обработка контента"],
            projectTypes: [
    ...
    [
        "Веб-дизайнер",
        {
            services: ["Разработка дизайн-макетов", "Дизайн лендингов", "Дизайн интернет-магазинов", "Сайты на тильда под ключ", "Верстка адаптивных сайтов"],
            additionalServices: [
    ...
    [
        "Иллюстратор",
        {
            services: ["Иллюстрации на заказ", "Концепт-арт и персонажи", "Иллюстрации для книг и статей", "Векторная графика"],
            additionalServices: ["Доработка иллюстраций", "Storyboard и скетчи", "Выбор стиля и композиции"],
            projectTypes: [
    ...
    [
        "3D-художник",
        {
            services: ["3D-моделирование", "3D-визуализация", "3D-анимация и рендер сцен", "Моделирование для VR/игр"],
            additionalServices: [
    ...
    [
        "SEO-специалист",
        {
            services: ["SEO-аудит", "Внутренняя SEO-оптимизация", "Внешняя SEO-оптимизация", "Сбор семантического ядра и анализ ключевых слов"],
            additionalServices: ["Мониторинг позиций сайта", "SEO-аналитика", "Накрутка ПФ", "Консультации по SEO"],
            projectTypes: [
    ...
    [
        "Таргетолог",
        {
            services: ["Таргет VK", "Таргет Instagram", "Таргет в TG ads", "Таргет Tiktok"],
            additionalServices: [
    ...
    [
        ...
        {
            services: ["Ведение WB/OZON под-ключ", "Управление ассортиментом и ценами", "Оптимизация карточек товаров", "Анализ продаж и отчетность"],
            additionalServices: [
    ...
    [
        "Авитолог",
        {
            ...
            projectTypes: ["Продвижение бизнеса под-ключ", "Массовое размещение объявлений", "Аудит и оптимизация аккаунта на Авито"],
            applications: [
                "Avito Pro",
    ...
    [
        "Сценарист",
        {
            ...
            additionalServices: ["Редактирование и доработка сценариев", "Консультации по сторителлингу", "Разработка сценарий для коротких видео"],
            projectTypes: [
                "Сценарий для Reels",
