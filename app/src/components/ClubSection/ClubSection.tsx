...
const benefits: PartialText[] = [
    {
        id: "club_benefits_services",
        textParts: [{text: "Слив"}, {text: "нестандартных связок", bold: true}, {text: "и сервисов"}]
    },
    {
        id: "club_benefits_sales",
        textParts: [{text: "Подборки полезных инструментов", bold: true}, {text: "для лидгена и автоматизации продаж"}]
    },
    {
        id: "club_benefits_templates",
        textParts: [{text: "Готовые шаблоны:", bold: true}, {text: "паки, офферы, тексты, оформление и т.д."}]
    },
    {
        id: "club_benefits_cases",
        textParts: [{text: "Эксклюзивные"}, {text: "разборы кейсов", bold: true}]
    }
]
            ...
            <div className={styles.clubHeader}>
                ...
                <div className={styles.titleContainer}>
                    ...
                    <span className={styles.subtitle}>
                        Закрытый канал с инсайдами, сервисами и готовыми шаблонами для участников.
                    </span>
                </div>
            </div>
                        ...
                        <div>
                            {textParts.map(({bold, text}, index) => (
                                <span key={index} className={styles.benefitText}>
                                    <span style={bold ? {} : {opacity: 0.5}}>{text}</span>
