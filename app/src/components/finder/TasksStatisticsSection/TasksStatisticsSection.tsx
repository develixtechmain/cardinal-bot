...
export const TasksStatisticsSection: React.FC<TasksStatisticsSectionProps> = ({user, tasks, tasksStats, subscription}) => {
        ...
        <div className={styles.container} style={{
            ...
            <div className={styles.stats}>
                <div className={styles.block}>
                    <div className={styles.tariffSection} style={{
                        '--border-color': goodColor,
                        '--background-color': isMoreThan3days ? "#7211F84D" : "#F8E8114D"
                    } as React.CSSProperties}>
                        ...
                        <div className={styles.daysLeftText}
                             style={{'--color': goodColor} as React.CSSProperties}>
                            <span>{daysLeft}</span>
