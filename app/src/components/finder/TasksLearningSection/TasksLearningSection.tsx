...
export const TasksLearningSection: React.FC<TasksLearningSectionProps> = ({openLearning, isActive}) => {
    ...
    return (
        <div className={styles.container}>
            ...
            <div className={styles.buttonsContainer}>
                    ...
                    <div className={styles.learningButton}>
                        <div className={styles.learningLabel}>
                            ...
                            <div className={styles.learning}>
                                ...
                                <span className={styles.learningDescription}>ИИ сам задаст уточняющие вопросы — это поможет улучшить результаты поиска</span>
                            </div>
                        </div>
                        <Info height="17px" width="17px" color="#7211F8"/>
                    </div>
                } buttonStyle={{borderRadius: 24, height: 79}} onClick={isActive ? openLearning : undefined}/>
                <WideButton color="#141414" text={
                ...
                } buttonStyle={{borderRadius: 24, height: 79}} onClick={isActive ? () => navigate("/finder/briefing/alert") : undefined}/>
            </div>
        </div>
    );
};
