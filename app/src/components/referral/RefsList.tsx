...
export const RefsList: React.FC<RefsListPropsProps> = ({refs}) => {
    ...
    const visibleRefs = useMemo(() => {
        ...
        return [
            ...refs.slice(0, maxItemsInLine),
            ...Array(Math.max(0, maxItemsInLine - refs.length)).fill(null),
        ];
            ...
            {refs.length === 0 ?
                ...
                <div ref={blockRef} className={styles.refsBlock}>
                    {visibleRefs.map((ref, index) =>
                        ref ? (
                            <div key={index} className={styles.ref} onClick={() => ref.username ?
                                ...
                                <div className={styles.refStatus} style={{
                                    color: ref.billed ? "#BEF811" : "white",
                                    backgroundColor: ref.billed ? "#BEF8114D" : "#FFFFFF4D"
                                }}>
