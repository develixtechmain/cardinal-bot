...
export const ProfileSection: React.FC<ProfileSectionProps> = ({user, subscription}) => {
    ...
    return (
        <>
            <div className={styles.container} style={{
                '--bottom-padding': `${isSubscriptionExpired ? 40 : 12}px`
            } as React.CSSProperties}>
                <div className={styles.header}>
                    <img height="30px" width="30px" src={user.avatar_url} alt=" "/>
                    <div className={styles.usernameContainer}><span
                        className={styles.username}>{`@${user.username}`}</span>
                    </div>
                    <div style={{flex: 1}}/>
                    <div className={styles.eagleContainer}><Eagle height="16px" width="16px"/></div>
                </div>
                {
                    isSubscriptionExpired && subscription.isTrialUsed() ?
                        <div className={styles.expiredSubscription} style={{
                            ...
                            <div className={styles.subscriptionButton} onClick={() => navigate("/subscription")} style={{
                        ...
                        <div className={styles.goodSubscription}>
                            <div className={styles.goodTariffSection} style={{
                                ...
                                <div className={styles.daysLeftText}
                                     style={{'--color': contentColor} as React.CSSProperties}>
                                    <span>{daysLeft}</span>
